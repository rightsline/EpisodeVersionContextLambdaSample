...
Execute unit tests
```
    cd "EpisodeVersionContextLambdaSample/test/EpisodeVersionContextLambdaSample.Tests"
    dotnet test
```

Deploy function to AWS Lambda
```
    cd "EpisodeVersionContextLambdaSample/src/EpisodeVersionContextLambdaSample"
